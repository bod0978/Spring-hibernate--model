...
<div data-role="page" id="pageone" data-theme="a" >
	...
	<div data-role="main" class="ui-content" >		
    	<table border=0 width=20% align="left"  bgcolor="#FFFFFF"  height="450px">
    		...
    		<tr align=center>
    			<td><a href="../booking/query" style="text-decoration:none;"><h4>訂位查詢</h4></a>	
    		<tr align=center>
    			<td><a href="../mem/view" style="text-decoration:none;" data-ajax="false"><h4>會員登出</h4></a>
    		<!-- tr align=center>
    			<td><a href="../mem/index" style="text-decoration:none;" data-ajax="false"><h4>回首頁</h4></a-->
    		<tr>
    	...
    	<table border=0 width=80% bgcolor="#FFFFFF" height="450px">
    		<tr>
    			<td align=center><font color="#bb1199"><h1>~<%=m.getName() %> 歡迎光臨美食天堂會員系統~<br><br>~Welcome to the gourmet heaven membership system~</h1>
    	</table>
  	</div>
