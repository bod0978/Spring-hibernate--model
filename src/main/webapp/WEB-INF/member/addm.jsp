...
<div data-role="page" id="pageone" data-theme="a" >
	...
	<form id="form1" name="form1" method="post" action="../mem/check" onclick="return false">	
	   	<table border=0 width=70%  bgcolor="#FFFFFF" height="450" align=center>
			<tr align=center>
				<td ><font color="red">*</font>帳號:
				<td><input type="text" name="user" id="user" ><span id="msg"></span></td>
				<td>
		 		<td>名稱:
			...
			<tr align=center>
				<td><label for="password"><font color="red">*</font>密碼:</label>
					...
					<td><img id="demo_img" onclick="hideShowPsw()" src="../pci/visible.png" alt="(顯示密碼 )">
					

				<td><font color="red">*</font>生日:
				<td><input type="text" id="body" name="body">
