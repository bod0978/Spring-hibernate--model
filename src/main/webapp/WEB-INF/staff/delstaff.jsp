	...
	<div data-role="main" class="ui-content" >		
		<table width=80% border=0 align=center >
			<tr>
				...
				<td align=center >
					<a href="" style="text-decoration:none;" data-ajax="false"><h3>1).新增員工資料</h3></a>
				<br>	
					<a href="" style="text-decoration:none;" data-ajax="false"><h3>2).修改員工資料及權限</h3></a>
				<br>	
					<a href="" style="text-decoration:none;" data-ajax="false"><h3>3).刪除員工資料</h3></a>	
				<br>	
					<a href="" style="text-decoration:none;" data-ajax="false"><h3>4).員工上下班管理</h3></a>		
