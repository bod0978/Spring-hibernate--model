		...
		<table width=100% border=0 align=center >
			<tr>
				...
				<td align="left" td align=center >
					<a href="../staff/addmem" style="text-decoration:none;" data-ajax="false"><h3>1).新增員工資料</h3></a>
				<br>	
					<a href="../staff/upsee" style="text-decoration:none;" data-ajax="false"><h3>2).修改員工資料及權限</h3></a>
				
				<br>	
					<a href="" style="text-decoration:none;" data-ajax="false"><h3>3).員工上下班管理</h3></a>		
